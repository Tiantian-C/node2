...
const server = http.createServer((req, res) => {
  ...
  if (pathName === "/" || pathName === "/overview") {
    ...
    //loop over the dataObj array and replace the template with each obj's information and save into a new array
      const cardsHtml = dataObj.map(el => replaceTemplate(tempard, el));
