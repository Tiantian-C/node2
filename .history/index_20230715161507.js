...
const replaceTemplate = (temp, product) => {
    let output = temp.replace(/{%PRODUCTNAME%}/g, product.productName);
     output = temp.replace(/{%IMAGE%}/g, product.productName);
     output = temp.replace(/{%PRICE%}/g, product.productName);
     output = temp.replace(/{%FROM%}/g, product.productName);
     output = temp.replace(/{%NUTRIENTS%}/g, product.productName);
     output = temp.replace(/{%QUANTITIES%}/g, product.productName);
     output = temp.replace(/{%DESCRIPTION%}/g, product.productName);
